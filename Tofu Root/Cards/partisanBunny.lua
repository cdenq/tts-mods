...
function createDiscardButton()
    self.createButton({
        ...
        color = "Black",
        font_color = "White",
        tooltip = "Discards all non-" .. titleCase(partisanType2) .. " cards from your hand."
    })
end
...
function discardCards(obj, color, alt_click)
    ...
    if discardCount > 0 then
        ...
        broadcastToAll(Player[color].steam_name .. " discards " .. discardCount .. " card(s) off of " .. partisanType2 .. " Partisans.", color)
    end
end